        ...
        <?php if (app()->user->isGuest): ?>
            ...
            <form>
                <div class="form-group">
                    <?php echo $form->textField($model, 'username', array('max-length' => '10', 'class' => 'form-control', 'placeholder' => 'email ili korisnicko ime')); ?>
                </div>
                <div class="form-group">
                ...
                <a class=" btn btn-primary btn-sm  btn-info"
                   href="<?php echo $this->createUrl('site/register') ?>">Prijava</a>

                <?php $this->endWidget(); ?>
            </form>
        <?php else: ?>
            <div class=" navbar-right">
                <span class="navbar-brand"><small>Dobrodosao,<?php echo app()->user->name; ?></small></span>
...
<?php echo $content; ?>
    ...
    <div class="container">
        <!-- Site footer -->
        <div class="footer">
            <p>&copy; TGroupCo d.o.o , Beograd, Srbija | <?php echo date("Y"); ?></p>
        </div>
    </div><!-- /.container -->
<?php $this->endContent(); ?>
