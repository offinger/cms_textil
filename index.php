...
defined('LOCAL_DOMAIN') or define('LOCAL_DOMAIN','fcms.private.local');
...
$yii=(!APP_DEPLOYED)?dirname(__FILE__).DS.'..'.DS.'frameworks'.DS .'framework'.DS .'yii.php':
//Server framework Path
dirname(__FILE__).DS.'..'.DS.'frameworks'.DS .'framework'.DS .'yii.php';
